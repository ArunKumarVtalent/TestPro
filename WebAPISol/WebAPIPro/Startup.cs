...
using WebAPIPro.DataAccess.Repository;
...
namespace WebAPIPro
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddDbContext<DBContextPro>(options => options.UseSqlServer("server=ARUN\\SQLEXPRESS;Uid=sa;password=143;database=ProjectDB27"));
